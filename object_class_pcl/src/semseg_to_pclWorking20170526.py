...
#			rospy.loginfo('Key is %s' % (key)) cis
			...
			width = 1616#use_clmat[key].width 1232 #segnet result 360
			height = 1232#use_clmat[key].height 1616 #segnet result 480
			...
			print "th_data:"
			print th_data
			all_valid = np.where(clmat_data == 6)[0]
		...
		all_valid = np.where(clmat_data ==1)[0]		
